<?php if(!class_exists('Rain\Tpl')){exit;}?> <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  ...
  <div>
    ...
    <div class="form-floating mb-3">
      <input type="text" class="form-control" name="category" id="floatingInput" placeholder="name@example.com">
      <label for="floatingInput"><i class="bi bi-tags-fill"></i> Nome da categoria</label>
    </div>

    <button class="btn btn-primary  py-2" type="submit"> <i class="bi bi-send-fill"></i>Criar Categoria</button>
