<?php if(!class_exists('Rain\Tpl')){exit;}?> <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group me-2">
             <a href="/admin/users" class="btn btn-primary btn-sm"> <i class="bi bi-people-fill"></i> Usuários</a>
  ...
  <div>
    ...
    <form class="mx-auto" style="max-width: 700px;" action ="/admin/users/create" method="POST">
  ...
  <div class="form-floating mb-3">
      <input type="password" class="form-control" name="senha" id="floatingPassword" placeholder="Confirm Password">
